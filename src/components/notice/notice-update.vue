...
<link rel="stylesheet" href="/happyhouse/assets/css/kakaomap.css" />
</head>
...
<body>
	...
	<form id="updateForm" method='post' action='${root}/notice/update?noticeNo=${notice.noticeNo}'>
		<div class="container">
			<div class="top-area">
					<div class="row">
						<div class="mb-3">
							...
							<div class="mt-3 mb-1 border-bottom">
								<div class="form-group">
									작성자: <input type="text" name="author" value="${notice.author}" readOnly/> |
									작성일: <input type="text" name="createdTime" value="${fn:substring(notice.createdTime,0,10)}" readOnly/>
								</div>
							</div>
					  </div>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-12">
						<textarea type="text" name="content" class="col-lg-12 col-md-12 col-12" >${notice.content}</textarea>
					</div>
			</div>
			...
			<div class="mt-3">
				...
				<span class="button">
		    		<a class="btn" href="${root}/notice/select?noticeNo=${notice.noticeNo}" >취소</a>
				</span>
			</div>
		</div>
	</form>
