...
export default {
    ...
    created() {
      http.get(`bookmark/detail?id=${this.$route.params.id}`)
      .then(({ data }) => {
    ...
    if (window.kakao && window.kakao.maps) {
      ...
      script.src = '//dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=b70f48995231071c0cead1213a57bb03&libraries=services';
