        ...
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-lg-6 col-md-12 col-12">
            ...
            <div class="content-right wow fadeInRight" data-wow-delay=".5s">
              ...
              <p>Where is My House는 고객에게 맞춤형 부동산 거래 정보를 알려주는 웹 서비스입니다. 아파트/주택 별, 매매/전월세 별 거래내역을 제공합니다.</p>
              <h3>What We Do</h3>
              <p>관심지역 북마크 기능을 지원하여 고객이 조금 더 편리하게 사이트를 이용할 수 있도록 돕고 있습니다. Free, Standartd, Premium의 다양한 요금제 선택하여 서비스를 이용해 보세요.</p>
              <!-- End Heading -->
            </div>
          </div>
        </div>
